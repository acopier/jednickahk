  ...
  return (
    <ContentPage title='Historie'>
      <p>
        ...
        Oddíl pod jeho vedením pomáhal s budováním nové skautské klubovny v
        Kuklenách, kde odpracovali členové oddílu desítky brigádnických hodin.
        Klubovna byla slavnostně otevřena v červnu 1969.
      </p>
      <p>
        Hned po otevření klubovny nastali práce na přípravě letního tábora. Díky
        velké zásluze br.J Kryspína bylo prostřednictvím paní Strnadové získáno
      ...
      <p>
        ...
        jsou Vydry, Fialová Rysové, Modrá Vlci, Žlutá Veverky a Zelená držina si
        vybrala jako svůj družinový znak ledňáčka. Oddíl pořádá během roku
